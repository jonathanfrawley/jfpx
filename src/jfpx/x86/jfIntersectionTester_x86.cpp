													...
													const jfVector3& axis)
{
    ...
    return ((boxHalfSize.getX() * jfRealAbs(axis.dotProduct(boxAxis0))) +
        	(boxHalfSize.getY() * jfRealAbs(axis.dotProduct(boxAxis1))) +
        	(boxHalfSize.getZ() * jfRealAbs(axis.dotProduct(boxAxis2))));
}
