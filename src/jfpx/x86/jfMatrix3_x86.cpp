...
void jfMatrix3_x86::multiply(const jfMatrix3& other, jfMatrix3* result) const
{
    ...
    tempResult.setElem(0, (m_Elems[0] * other.getElem(0)) + (m_Elems[1] * other.getElem(3)) + (m_Elems[2] * other.getElem(6)));
    tempResult.setElem(1, (m_Elems[0] * other.getElem(1)) + (m_Elems[1] * other.getElem(4)) + (m_Elems[2] * other.getElem(7)));
    tempResult.setElem(2, (m_Elems[0] * other.getElem(2)) + (m_Elems[1] * other.getElem(5)) + (m_Elems[2] * other.getElem(8)));
    tempResult.setElem(3, (m_Elems[3] * other.getElem(0)) + (m_Elems[4] * other.getElem(3)) + (m_Elems[5] * other.getElem(6)));
    tempResult.setElem(4, (m_Elems[3] * other.getElem(1)) + (m_Elems[4] * other.getElem(4)) + (m_Elems[5] * other.getElem(7)));
    tempResult.setElem(5, (m_Elems[3] * other.getElem(2)) + (m_Elems[4] * other.getElem(5)) + (m_Elems[5] * other.getElem(8)));
    tempResult.setElem(6, (m_Elems[6] * other.getElem(0)) + (m_Elems[7] * other.getElem(3)) + (m_Elems[8] * other.getElem(6)));
    tempResult.setElem(7, (m_Elems[6] * other.getElem(1)) + (m_Elems[7] * other.getElem(4)) + (m_Elems[8] * other.getElem(7)));
    tempResult.setElem(8, (m_Elems[6] * other.getElem(2)) + (m_Elems[7] * other.getElem(5)) + (m_Elems[8] * other.getElem(8)));
    (*result) = tempResult;
}
...
void jfMatrix3_x86::multiply(const jfVector3& vec, jfVector3* result) const
{
    ...
    tempResult.setY((vec.getX() * m_Elems[3]) + (vec.getY() * m_Elems[4]) + (vec.getZ() * m_Elems[5]));
    tempResult.setZ((vec.getX() * m_Elems[6]) + (vec.getY() * m_Elems[7]) + (vec.getZ() * m_Elems[8]));
    (*result) = tempResult;
}
