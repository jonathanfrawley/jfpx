...
**/
#include "jfBoxesAndBalls3DGraphicsHandler_x86.h"

jfBoxesAndBalls3DGraphicsHandler_x86::jfBoxesAndBalls3DGraphicsHandler_x86()
{
}
...
int jfBoxesAndBalls3DGraphicsHandler_x86::loadGLTextures()
{
    int status = 0;
...
void jfBoxesAndBalls3DGraphicsHandler_x86::initObjects()
{
    loadGLTextures();
...
void jfBoxesAndBalls3DGraphicsHandler_x86::drawObjects() const
{
...
void jfBoxesAndBalls3DGraphicsHandler_x86::drawDebug(vector<jfContact*> contacts) const
{
