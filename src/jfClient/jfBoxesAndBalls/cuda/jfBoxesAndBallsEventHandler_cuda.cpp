...
**/
#include "jfBoxesAndBallsEventHandler_cuda.h"

jfBoxesAndBallsEventHandler_cuda::jfBoxesAndBallsEventHandler_cuda()
{
}
...
void jfBoxesAndBallsEventHandler_cuda::handleMouseEvents()
{
    int x,y;
